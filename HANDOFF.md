...
핵심 콘텐츠(한자 학습 2138자, 문법 470개, 단어 7972개) 전부 완료, 메뉴 구조 개편(한자 통합)·학습 플로우 변경(배치→나가기/이어하기)·카드 레이아웃 조밀화·로그인/클라우드 동기화(실제 동작 확인됨)·SRS 간격반복 복습까지 2026-07-09 하루에 전부 구현·검증·배포 완료.
