...
4. **한자 학습 콘텐츠(etymology) N4~N1 — 진행 중.** 2058자 전체를 목표로 급수 순서(N4→N3→N2→N1)·num 순서대로 100자씩 배치 작업 중, 배치마다 즉시 commit+push(세션이 언제 끊길지 몰라 진행상황을 계속 저장해두기로 함).
   - **완료**: N4 전체(166/166), N3 전체(367/367), N2 전체(367/367) — playwright로 다 브라우저 검증 완료. 지금까지 총 980/2138자.
   - **다음 재개 지점**: N1-1부터 (`data/kanji.json`에서 `level==='N1'`, `num` 오름차순 정렬) — 남은 마지막 급수, 1158자
