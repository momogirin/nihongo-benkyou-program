...
2026-07-08 기준 **N5(85개) · N4(59개) 완료**. N3~N1은 아직 미작성 — 급수가 올라갈수록 문법의 뉘앙스 차이가 커지고 예문의 정확도 검증이 더 어려워지므로, 이어서 작성할 때 표현 수위를 더 보수적으로 조정할 것 (study-n5.json의 etymology 필드에 적용한 원칙과 동일).
