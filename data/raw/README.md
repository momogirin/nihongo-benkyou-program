...
2026-07-08 기준 **N5(85개) · N4(59개) · N3(71개) 완료**. N3는 TRY!/新完全マスター 수준에서 여러 교재가 공통으로 다루는 항목 위주로, N4와 마찬가지로 급수 경계가 애매한 항목은 배제하고 선정했다. N2~N1은 아직 미작성 — 급수가 올라갈수록 문법의 뉘앙스 차이가 커지고 예문의 정확도 검증이 더 어려워지므로, 이어서 작성할 때 표현 수위를 더 보수적으로 조정할 것 (study-n5.json의 etymology 필드에 적용한 원칙과 동일).
